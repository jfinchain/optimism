...
if [ ! -f "$DEVNET/done" ]; then
  ...
  (
    ...
    go run cmd/main.go genesis l2 \
        ...
        --deploy-config ../packages/contracts-bedrock/deploy-config/jfin-testnet.json \
        --deployment-dir ../packages/contracts-bedrock/deployments/jfin-testnet \
...
# L2OO_ADDRESS="0xfB6853b1a8ECe1Ac98099C6995DD7A06A4DA525d"
